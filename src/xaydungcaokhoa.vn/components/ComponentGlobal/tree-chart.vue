...
td{position: relative; vertical-align: top;padding:0 0 30px 0;text-align: center; }
...
.node{position: relative; display: inline-block;box-sizing: border-box; text-align: center; border: 1px solid black; padding: 10px 20px;}
...
.node .person .name{font-weight: 700; white-space: pre-wrap; height:2em;line-height: 2em;width:100%;}
